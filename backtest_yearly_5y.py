# -*- coding: utf-8 -*-
"""
四大红利全收益指数 5年每年定投回测 + 真实回撤计算
规则: 每年年初(1月首个交易日)定投100000元, 2022-01 ~ 2026-07, 共5期, 总投入50万
输出: result_yearly_5y.json (供网页使用)
"""
...
AMOUNT = 100000.0
START, END = "2022-01", "2026-07"   # 定投区间(每年年初定投, 2022-2026 共5期)
...
json.dump(result, open("result_yearly_5y.json", "w", encoding="utf-8"), ensure_ascii=False, indent=1)
